    ...
    >
      ...
      <div className="z-10">
        ...
        <div className="socials flex flex-row gap-2">
          <Link href="https://github.com/gowtham-source">
            <Image src={GithubIcon} alt="Github Icon" />
          </Link>
          <Link href="https://www.linkedin.com/in/gowtham-m-956363205/">
            <Image src={LinkedinIcon} alt="Linkedin Icon" />
          </Link>
          <Link href="https://www.instagram.com/mystical_boy_25/">
            <Image src={InstaIcon} alt="Linkedin Icon" />
          </Link>
          <Link href="https://www.threads.net/@mystical_boy_25">
            <Image src={ThreadsIcon} alt="Threads Icon" />
          </Link>
          <Link href="https://www.youtube.com/@Gowtham25">
            <Image src={YoutubeIcon} alt="Youtube Icon" />
          </Link>
          <Link href="https://discord.gg/aEmU6zVN">
